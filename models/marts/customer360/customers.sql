with
    ...
    orders_table as (select * from {{ ref("orders") }}),
    ...
    order_summary as (
        ...
        left join
            order_items_table as order_items on orders.order_id = order_items.order_id
    ...
    joined as (
        ...
        select
            ...
            case
                when order_summary.is_repeat_buyer then 'returning' else 'new'
